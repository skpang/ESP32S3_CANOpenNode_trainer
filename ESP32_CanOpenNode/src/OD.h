...
********************************************************************************
    ...
    File info:
        ...
        Project File: ESP32S3_CANopen_IO_demo.xdd
        File Version: 1

        Created:      03/10/2025 12:00:00
        Created By:   
        Modified:     03/10/2025 17:13:54
        Modified By:  

    Device Info:
        Vendor Name:  SK Pang Electronics Ltd
        Vendor ID:    12
        Product Name: ESP32S3 CANOpen IO demo
        Product ID:   12345
...
#define OD_ENTRY_H6200 &OD->list[25]
#define OD_ENTRY_H6401 &OD->list[26]
...
#define OD_ENTRY_H6000_readInput8Bit &OD->list[23]
#define OD_ENTRY_H6001_counter &OD->list[24]
#define OD_ENTRY_H6200_writeOutput8Bit &OD->list[25]
#define OD_ENTRY_H6401_readAnalogueInput16Bit &OD->list[26]

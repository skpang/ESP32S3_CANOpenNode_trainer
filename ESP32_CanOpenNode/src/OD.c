...
OD_ATTR_PERSIST_COMM OD_PERSIST_COMM_t OD_PERSIST_COMM = {
    ...
    .x1A00_TPDOMappingParameter = {
        ...
        .applicationObject3 = 0x60000108,
        .applicationObject4 = 0x00020008,
        .applicationObject5 = 0x00020008,
        .applicationObject6 = 0x00020008,
        .applicationObject7 = 0x00000000,
        .applicationObject8 = 0x00000000
    },
...
OD_ATTR_RAM OD_RAM_t OD_RAM = {
    ...
    .x6000_readInput8Bit_sub0 = 0x01,
    .x6000_readInput8Bit = {0x43},
    .x6001_counter = 0x00000000,
    .x6200_writeOutput8Bit_sub0 = 0x01,
    .x6200_writeOutput8Bit = {0x00},
    .x6401_readAnalogueInput16Bit_sub0 = 0x04,
    .x6401_readAnalogueInput16Bit = {0x1234, 0x5678, 0x0000, 0x0000}
};
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x6000, 0x02, ODT_ARR, &ODObjs.o_6000_readInput8Bit, NULL},
    {0x6001, 0x01, ODT_VAR, &ODObjs.o_6001_counter, NULL},
    {0x6200, 0x02, ODT_ARR, &ODObjs.o_6200_writeOutput8Bit, NULL},
    {0x6401, 0x05, ODT_ARR, &ODObjs.o_6401_readAnalogueInput16Bit, NULL},
